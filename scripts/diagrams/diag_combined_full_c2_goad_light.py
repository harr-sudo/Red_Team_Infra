"""combined-full-light — c2-full + goad-light, 3-way VPC peering.
...
VPCs:
  ...
  * GOAD VPC 192.168.56.0/24   — goad-light (2 DCs + 1 srv, parent/child)

GOAD-light = single forest, parent-child trust:
...
with rt_diagram("Combined — C2 Full + GOAD Light (3-way VPC peering)", "combined-full-c2-goad-light"):
    ...
    # ── GOAD VPC (goad-light, parent-child) ──────────────────────────────
    with Cluster("GOAD VPC  192.168.56.0/24  (goad-light · parent-child)"):
    ...
    # C2 <-> GOAD peering: beacons from the C2 team servers reach the AD lab.
