"""goad-light — 2 DC + 1 member server, parent-child trust
(sevenkingdoms.local + north.sevenkingdoms.local), fronted by the
...
with rt_diagram("GOAD-Light — Dashboard-fronted AD lab", "goad-light-architecture"):
    op = operator()
    ...
    with Cluster("GOAD VPC  192.168.56.0/24"):
        ...
        with Cluster("Private subnet  .0/26"):
            ...
            with Cluster("GOAD AD targets — sevenkingdoms.local forest"):
        ...
        # Parent-child trust between the two domains.
