...
13. **D5 — Dashboard upgrade** — live deployments grid, recent activity feed (depends on item 4 audit log), cost trend tile, "Create new deployment" CTA. (§19.5 Phase 5) *Half-day after item 4 lands.*
