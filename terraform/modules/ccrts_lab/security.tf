...
# (no inbound from the internet — the dashboard is the jump). The lab is fully
# self-contained: no C2 VPC peering.
# =============================================================================
...
# =============================================================================
# KALI SG — operator SSH access via the dashboard VPC peer
# =============================================================================
...
# =============================================================================
# WINDOWS WORKSTATION SG — RDP + WinRM from the dashboard VPC
# =============================================================================
...
# =============================================================================
# AD DC SG — WinRM + RDP from dashboard, AD replication inside the fabric SG
# =============================================================================
...
resource "aws_security_group_rule" "ad_dc_rdp_from_dashboard" {
  ...
  protocol          = "tcp"
  cidr_blocks       = [var.dashboard_vpc_cidr]
  security_group_id = aws_security_group.ad_dc.id
}
...
# =============================================================================
# AD WORKSTATION SG — RDP + WinRM from dashboard
# =============================================================================
...
resource "aws_security_group_rule" "ad_ws_rdp_from_dashboard" {
  ...
  protocol          = "tcp"
  cidr_blocks       = [var.dashboard_vpc_cidr]
  security_group_id = aws_security_group.ad_ws.id
}
...
# =============================================================================
# ELK SG — SSH (admin) + Kibana 5601 from the dashboard VPC
# =============================================================================
